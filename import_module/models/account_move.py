...
class account_move_module(models.Model):
    ...
    #             if line.id_import:
    #                 line.is_landed_costs_line = True
...
class AccountMoveLine(models.Model):
    ...
    def create(self, vals_list):
        ...
        for line in lines:
            move = line.move_id
            #Se salta la linea si es parte de un movimiento de stock
            if move.stock_move_id:
                continue
            
            #Si tiene guía de importación, marcar como línea de costo en destino
            if move.move_type == 'entry' and line.id_import:
                line.is_landed_costs_line = True
